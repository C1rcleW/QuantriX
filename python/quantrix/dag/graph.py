    ...
    def to_dict(self):
        return {
            "nodes": [{"id": str(n.id), "kind": n.kind.value, "label": n.label,
                        "status": n.status.value, "method": n.method,
                        "description": n.description} for n in self.nodes.values()],
            "edges": [{"source": str(e.source_id), "target": str(e.target_id), "label": e.label} for e in self.edges],
        }
