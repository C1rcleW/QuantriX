...
class DecisionTree:
    ...
    def _recommend_descriptive(
        ...
        if independents and all(iv.is_categorical for iv in independents):
            candidates.append(MethodCandidate(
                ...
                assumptions=["Expected frequencies should be ≥ 5 in ≥ 80% of cells for chi-square."],
            ))
        ...
        if dependent.is_continuous:
            if n_groups == 2:
                candidates.append(MethodCandidate(
                    ...
                    alternatives=["Mann-Whitney U test (nonparametric)", "Welch's t-test (unequal variances)"],
                ))
                candidates.append(MethodCandidate(
                    ...
                    assumptions=["Independence of observations.", "Ordinal or continuous dependent."],
                ...
                candidates.append(MethodCandidate(
                    ...
                    alternatives=["Kruskal-Wallis test (nonparametric)", "Welch's ANOVA (unequal variances)"],
                ))
                candidates.append(MethodCandidate(
        ...
        # Ordinal dependent
            ...
            if n_groups == 2:
                candidates.append(MethodCandidate(
                    ...
                    assumptions=["Independence of observations.", "Similar distribution shape across groups."],
                ))
            else:
                candidates.append(MethodCandidate(
                    method_name="kruskal_wallis",
    ...
    def _recommend_association(
        ...
        elif dependent.variable_type == VariableType.ORDINAL or iv.variable_type == VariableType.ORDINAL:
            candidates.append(MethodCandidate(
                method_name="spearman_correlation",
                display_name="Spearman Rank Correlation",
                method_family="correlation",
