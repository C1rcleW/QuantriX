...
from quantrix.interpreter.engine import ResultInterpreter, InterpretationResult
...
class TestResultInterpreter:
    ...
    def test_correlation_interpretation(self, interpreter):
        result = interpreter.interpret("pearson_correlation", {
            "dv_label": "Income",
    ...
    def test_anova_interpretation(self, interpreter):
        result = interpreter.interpret("oneway_anova", {
            "dv_label": "Test Score",
    ...
    def test_descriptive_interpretation(self, interpreter):
        result = interpreter.interpret("descriptive_statistics", {
            "dv_label": "Age",
            "n": 100,
            "n_valid": 95,
            "missing_count": 5,
    ...
    def test_key_findings_significance(self, interpreter):
        result = interpreter.interpret("chi_square", {
            "dv_label": "Gender",
            "iv_label": "Region",
            "p_value": 0.002,
            "chi_sq": 15.3,
